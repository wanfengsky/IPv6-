package com.yi.project.system.notice.controller;
...
import com.yi.project.system.notice.domain.Notice;
import com.yi.project.system.notice.service.INoticeService;
...
public class NoticeController extends BaseController
{
    ...
    @RequiresPermissions("system:notice:view")
    @GetMapping("/view")
    public String view(Long noticeId, ModelMap mmap)
    {
        mmap.put("notice", noticeService.selectNoticeById(noticeId));

package com.yi.project.system.role.service;
...
import com.yi.framework.aspectj.lang.annotation.DataScope;
import com.yi.project.system.role.domain.Role;
import com.yi.project.system.role.domain.RoleDept;
import com.yi.project.system.role.domain.RoleMenu;
import com.yi.project.system.role.mapper.RoleDeptMapper;
import com.yi.project.system.role.mapper.RoleMapper;
import com.yi.project.system.role.mapper.RoleMenuMapper;
import com.yi.project.system.user.domain.UserRole;
import com.yi.project.system.user.mapper.UserRoleMapper;
...
public class RoleServiceImpl implements IRoleService
{
    ...
    public String getRolesByUserId(Long userId){
        ...
        String roleKey = "teacher";
        for(Role role : roles){
            if(role.isFlag() && role.getRoleKey().equals("admin")){
                roleKey = "admin";
                break;
            } else if(role.isFlag() && role.getRoleKey().equals("teacher")) {
                roleKey = "teacher";
                break;
            } else if(role.isFlag() && role.getRoleKey().equals("student")) {
                roleKey = "student";
                break;
            } else if(role.isFlag() && role.getRoleKey().equals("manager")) {
                roleKey = "manager";
                break;
            }
        }
